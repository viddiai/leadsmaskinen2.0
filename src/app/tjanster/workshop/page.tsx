          ...
          <div className="mx-auto mt-10 max-w-2xl">
            <Card highlighted>
              <div className="text-center">
                <p className="text-h2 font-[family-name:var(--font-display)] font-medium text-white">
                  7 500 <span className="text-h3 text-white/60">kr</span>
                </p>
                ...
                <ul className="space-y-3">
                  {DELIVERABLES.map((item) => (
                    <li key={item} className="flex items-start gap-3">
                      ...
                      <span className="text-body text-white/60">{item}</span>
                    </li>
                  ))}
                </ul>
              </div>
